  ...
  <section class="row">
    <div class="col-lg-7 d-flex align-content-between flex-wrap">
      ...
      <div class="d-flex justify-content-between flex-grow-1 align-items-center">
        <a href="<?= URLROOT; ?>/user/login.php"class="btn btn-lg btn-primary">Order now</a>
        <div class="">
          <a href="<?= URLROOT; ?>/menu.php" class="link-underline link-underline-opacity-0">Browse menu
    ...
    <div class="col-lg-5 mt-lg-0 mt-3">
      <img class="shadow rounded object-fit-cover img-fluid h-100" src="<?= URLROOT; ?>/img/cake.jpeg" alt="">
    </div>
  </section>
</div>
